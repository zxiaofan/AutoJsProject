var versionUrl = "http://zxiaofan.com/tc/b/201911/mbversion.txt";
...
var AliMB = require("./AliMB.js");

var main_funMB = {};

// 联系我
main_funMB.findMe = function findMe(dyh) {
...
// 检查更新
// checkUpdate 没有括号
main_funMB.checkUpdate = function checkUpdate(version) {
    // var thread = threads.start(function () {
...
main_funMB.main_method = function main_method(method, boolThread) {
    if ("天猫喵币" == method) {
        ...
        if (boolThread) {
            ...
            var thread = threads.start(function () {
                AliMB.fun_ZFBMB();
                dis_result2.setAndNotify(1);
            });
            dis_result2.blockedGet()
            return dis_result2;
        } else {
            AliMB.fun_ZFBMB();
        }
